 ...
 * <ul>
 *   <li><a href="https://hawkesy.blogspot.com/2010/05/catmull-rom-spline-curve-implementation.html">Catmull-Rom Spline Curve Implementation</a></li>
 *   <li><a href="https://dl.acm.org/doi/epdf/10.1145/378456.378511">ACM: Catmull-Rom Paper</a></li>
 *   <li><a href="https://stackoverflow.com/questions/9489736/catmull-rom-curve-with-no-cusps-and-no-self-intersections">Stack Overflow: Catmull-Rom with no cusps or self-intersections</a></li>
 * </ul>
 */
public class SmoothLineChart extends LineChart<String, Number> {
    ...
    private List<double[]> collectPointsFromPath(Path path) {
        ...
        for (PathElement element : path.getElements()) {
            if (element instanceof MoveTo mt) {
                points.add(new double[]{mt.getX(), mt.getY()});
            } else if (element instanceof LineTo lt) {
    ...
    /**
     * <p><b><u>Catmull-Rom tangent at P_i:</u></b></p>
     * <p>T_i = (P_{i+1} - P_{i-1}) / 2</p>
     *
     * <p><b><u>For segment P1 to P2 with neighbours P0 and P3:</u></b></p>
     * <ul>
     *   <li>cp1 = P1 + TENSION * (P2 - P0) / 6</li>
     *   <li>cp2 = P2 - TENSION * (P3 - P1) / 6</li>
     * </ul>
     *
     * <p><b><u>The /6 factor comes from the Hermite-to-Bezier conversion:</u></b></p>
     * <ul>
     *   <li>Tangent scale = 1/3 of segment in Bezier form.</li>
     *   <li>Combined with the 1/2 from Catmull-Rom's tangent formula.</li>
     * </ul>
     *
     * <p>TENSION below 1 shortens the tangent vectors, pulling the Bezier
     * handles closer to the data point and preventing overshooting
     * at peaks and valleys.</p>
     *
     * <p>Time Complexity: O(n), one CubicCurveTo per segment, no inner loop.</p>
     * <p>Space Complexity: O(1), path modified in-place.</p>
     */
...
/*
 ...
 Charts now successfully render with smooth Catmull-Rom spline interpolation using cubic Bézier curves.
 */
